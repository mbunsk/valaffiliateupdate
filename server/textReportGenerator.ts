...
┌──────────────────────────────────────────────────────────────────────────────┐
│                          ${data.validationData.idea.toUpperCase()}                          │
...
💡 THE OPPORTUNITY
${data.validationData.idea} is a validated startup opportunity targeting ${data.validationData.targetCustomer} 
with a comprehensive solution for ${data.validationData.problemSolved}.

${valueProposition}

📊 KEY METRICS
• Market Validation Score: ${score}/100
• Customer Interviews Completed: ${data.customerInsights.length} target users
...
🌟 WHY INVEST IN ${data.validationData.idea.toUpperCase()}:
...
╔══════════════════════════════════════════════════════════════════════════════╗
║                    Generated through ValidatorAI.com                        ║
║                  🤖 The AI-Powered Startup Validation Platform 🤖           ║
╚══════════════════════════════════════════════════════════════════════════════╝
    `;
  }
